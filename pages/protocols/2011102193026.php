			...
			<div id="main" role="main">
			  <div id="aside">
			      ...
			      <li><h4>Pages</h4>
					...
					<li><h4>Categories</h4>
						<ul><li><a href='../protocol_more.php?subject=aflasf'>aflasf</a>(1)</li><li><a href='../protocol_more.php?subject=Biochemistry'>Biochemistry</a>(1)</li><li><a href='../protocol_more.php?subject=bioinformation'>bioinformation</a>(1)</li><li><a href='../protocol_more.php?subject=Computer application'>Computer application</a>(1)</li><li><a href='../protocol_more.php?subject=fadfjkalkdjflak'>fadfjkalkdjflak</a>(1)</li><li><a href='../protocol_more.php?subject=math'>math</a>(1)</li><li><a href='../protocol_more.php?subject=nmr'>nmr</a>(1)</li><li><a href='../protocol_more.php?subject=uncategorized'>uncategorized</a>(3)</li>						</ul>		
					</li>
					<li><h4>Archives</h4>
						<ul><li><a href='../protocol_more.php?subject=2011-9'>2011-9</a>(8)</li><li><a href='../protocol_more.php?subject=2011-10'>2011-10</a>(2)</li>						</ul>					
					</li>
					<li><h4>Links</h4>
						<ul>
			  ...
			  <div id="content">
			    <header>
			      <h2><a href="#">alkfjalkd</a></h2>
		        </header>
		        <div id="protocol_id" style="display:none">10</div>
		        <div id="protocol_info">
		        <!--<span>time</span>
		        <span>Categories</span>	-->
		        <span>[article]</span>
		        <span>[<a href="../protocol_edit.php?id=10">Edit</a>]</span>
		        <span>[<a href="../protocol_history.php?id=10">History</a>]</span>
		        <span>[<a href="../protocol_discussion.php?id=10">Discussion</a>]</span>
		        </div>
		        <div id="new_protocol">
		        aldkfjrigalkvakjfakmdkj<br />
		        </div>
			  </div>
			  <!-- content -->
		  </div>
